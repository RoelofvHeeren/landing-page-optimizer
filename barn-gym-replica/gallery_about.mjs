...
const directoryPath = path.join(__dirname, 'public', 'images', 'about');
...
<html>
<head>
    <title>Downloaded Images Gallery (About)</title>
    <style>
...
<body>
    <h2>Downloaded Images Gallery (About)</h2>
    <div class="gallery">
        ${files.map(file => `
        <div class="item">
...
const galleryPath = path.join(__dirname, 'gallery_about.html');
...
(async () => {
    ...
    await page.screenshot({ path: 'gallery_about_full.png', fullPage: true });
    await browser.close();
    console.log('Gallery screenshot generated: gallery_about_full.png');
})();
